...
if ( function_exists('acf_add_options_page') ) {
    ...
    acf_set_options_page_menu('FVG Site Options');
...
add_action('acf/init', 'image_banner_block');
function image_banner_block() {

    // check function exists.
    if( function_exists('acf_register_block') ) {

        // register an Image Banner block.
        acf_register_block(array(
            'name'              => 'image_banner_block',
            'title'             => __("Image Banner"),
            'description'       => __("The block for the Image Banner that holds a full width image for the header of all pages."),
            'render_template'   => 'template-parts/blocks/image-banner-block.php',
            'enqueue_style'     => get_template_directory_uri() . '/style.css',
            'category'          => 'layout',
            'icon'              => 'images-alt2',
            'mode'              => 'edit',
            'keywords'          => array('image', 'banner', 'header'),
        ));
    }
}
...
function cards_with_captions_block() {
    ...
    if( function_exists('acf_register_block') ) {
        ...
        acf_register_block(array(
            ...
            'description'       => __("The block for the Cards with Captions that is a grid of profile images with a title and subtile."),
            'render_template'   => 'template-parts/blocks/cards-with-captions-block.php',
            'enqueue_style'     => get_template_directory_uri() . '/style.css',
            'category'          => 'layout',
            'icon'              => 'id-alt',
            'mode'              => 'edit',
            'keywords'          => array('cards', 'captions', 'image'),
        ));
    }
}

add_action('acf/init', 'text_cards_block');
function text_cards_block() {
    ...
    if( function_exists('acf_register_block') ) {
        ...
        acf_register_block(array(
            ...
            'title'             => __("Text Cards"),
            'description'       => __("The block for the Text Cards that is a row of 3 cards holding a heading and a paragraph in each."),
            'render_template'   => 'template-parts/blocks/text-cards-block.php',
            'enqueue_style'     => get_template_directory_uri() . '/style.css',
            'category'          => 'layout',
            'icon'              => 'id-alt',
            'mode'              => 'edit',
            'keywords'          => array('cards', 'text', 'row'),
        ));
    }
}
