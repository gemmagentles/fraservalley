            ...
            <?php $content_box = get_sub_field( 'heading' ); ?>
                ...
                <?php if ( $content_box ) { ?>
                    <div class="content-overlay-panel__text-wrapper">
                        ...
                        <?php if ( $button_link ) { ?>
                            <button data-aos="fade" data-aos-easing="ease-in" data-aos-delay="500" data-aos-duration="550" class="fvg-button" onclick="location.href='<?php echo $button_link['url']; ?>'" type="button"><?php the_sub_field( 'button_text' ); ?></button>
                        <?php } ?>
                    </div>
                <?php } ?>
            </div>
