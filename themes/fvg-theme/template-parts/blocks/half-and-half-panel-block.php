...
<div class="half-and-half-panel">
    ...
    <div class="half-and-half-panel__wrapper<?php if ( get_sub_field( 're-order' ) == 1 ) { ?> half-and-half-panel__order-left<?php } ?>">
            <div class="half-and-half-panel__text-wrapper">
                ...
                <?php if ( $button_link ) { ?>
                    <button data-aos="fade-right" data-aos-easing="ease-in" data-aos-delay="500" data-aos-duration="550" class="fvg-button" onclick="location.href='<?php echo $button_link['url']; ?>'" type="button"><?php the_sub_field( 'button_text' ); ?></button>
                <?php } ?>
            </div>
